...
<iframe src="JSP/Menu.jsp" style="width:14%;height:88vh;border:none; overflow:hidden;"></iframe>



<iframe name="menu"src="JSP/Home.jsp" style="width:85%;height:88vh;border:none; overflow:hidden;"></iframe>
</div>
