...
<div style="height:100px; background-color: darkcyan;position: -webkit-sticky;
  position: sticky;  top: 0;">
       ...
       <div class="dropdown">
  <button style=" border:none;margin-right:20px;"><i class="fa-regular fa-user" style="font-size:25px;"></i></button>
...
<iframe src="JSP/AdminHome.jsp" name="adminHome" style="width:15%;height:88vh; border:none;overflow:hidden;"></iframe>



<iframe src="JSP/Home.jsp" name="admin" style="width:85%;height:88vh; border:none;overflow:hidden;"></iframe>
